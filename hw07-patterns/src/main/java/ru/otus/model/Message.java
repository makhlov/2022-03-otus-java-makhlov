...
public class Message implements Cloneable {
    ...
    private Message(
            long id, String field1, String field2, String field3, String field4, String field5, String field6,
    ...
    public Message clone() {
        ...
        var objectForMessage = this.getField13();
        if (objectForMessage != null) {
            builder.field13(objectForMessage.clone());
        }
    ...
    public static class Builder {
        ...
        private Builder(
                long id, String field1, String field2, String field3, String field4,
